...
type
  TfDaruma_iMFLer_ECF = class(TForm)
    BT_ENVIAR: TButton;
    BT_FECHAR: TButton;
    GroupBox1: TGroupBox;
    Label3: TLabel;
...
var
  fDaruma_iMFLer_ECF: TfDaruma_iMFLer_ECF;
...
procedure TfDaruma_iMFLer_ECF.BT_FECHARClick(Sender: TObject);
begin
   Close;
end;

procedure TfDaruma_iMFLer_ECF.BT_ENVIARClick(Sender: TObject);
...
procedure TfDaruma_iMFLer_ECF.CBX_TipoClick(Sender: TObject);
begin
